...
return [
    ...
    'file-access-m0' => 'File "<a href="%2$s" class="alert-link">%1$s</a>" is now locked',
    'file-access-m1' => 'File "<a href="%2$s" class="alert-link">%1$s</a>" is now shareable',
    'file-access-m2' => 'File "<a href="%2$s" class="alert-link">%1$s</a>" is now open to the public',
    'file-access-m3' => 'Not owner of file',
    'file-access-m4' => 'User was not found',
