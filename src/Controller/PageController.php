...
class PageController extends BaseController {
    ...
    public function systemAction($request, $response, $args) {
        ...
        return $this->view->render($response, 'page/system.html.twig', array_merge($args, [
            ...
            'publicFiles' => $this->em->getRepository('App\Entity\File')->findBy(['fileIncluded' => FALSE, 'access' => 2]),
            'shareableFiles' => $this->em->getRepository('App\Entity\File')->findBy(['fileIncluded' => FALSE, 'access' => 1]),
            'privateFiles' => $this->em->getRepository('App\Entity\File')->findBy(['fileIncluded' => FALSE, 'access' => 0]),
