...
function initUpdateFile() {
    (function($) {
        ...
        var btnFolderTpl = '<label class="btn btn-primary btn-sm mr-2 mb-2 %s">%s <i class="fas fa-fw fa-check"></i><i class="fas fa-fw fa-times"></i> <i class="fas fa-%s"></i><input value="%s" type="checkbox" class="update-file-folder" %s/></label>';
        
        // 1: button class, 2: active class, 3: label, 4: access icon, 5: value, 6: checked attribute
        var btnAccessTpl = '<label class="btn btn-%s btn-sm mr-2 mb-2 %s">%s <i class="fas fa-fw fa-check"></i><i class="fas fa-fw fa-times"></i> <i class="fas fa-%s"></i><input value="%s" type="radio" class="update-file-access" name="update_file_access" %s/></label>';
        ...
        $('#update-file').on('show.bs.modal', function(event) {
            ...
            modal.find('button.submit-form').click(function() {
                var file = {
                    ...
                    folders: (function() {
                        var folders = []; // eslint-disable-line array-bracket-newline
