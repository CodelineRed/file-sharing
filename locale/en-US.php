...
return [
    ...
    'auth-text' => 'Open the Google Authenticator app and enter your code, then click Submit.',
    'back-to' => 'Back to',
    'choose-file' => 'max. %1$s',
    'close' => 'Close',
    'code' => 'Code',
    ...
    'folder-not-accessible' => 'Folder is not accessible',
    'folder-not-exists' => 'Folder doesn\'t exists',
    'folders' => 'Folders',
    'guest' => 'Guest',
    'lock-file-extension' => 'Lock file extension',
    'lock-user' => 'Lock user',
    'locked' => 'Locked',
    'locked-file-extensions' => 'Locked file extensions',
    ...
    'no-folders' => 'No folders were found',
    ...
    'private' => 'Locked',
    'private-file' => 'Share file',
    'private-files' => 'Private files',
    'private-folder' => 'Share folder',
    'provider' => 'Provider',
    'public' => 'Open to the public',
    'public-file-extensions' => 'Public file extensions',
    'public-file' => 'Lock file',
    'public-files' => 'Public files',
    'public-users' => 'Public users',
    'public-folder' => 'Lock folder',
    'purpose' => 'Purpose',
    ...
    'session' => 'Session',
    'shareable' => 'Shareable',
    'shareable-file' => 'Unlock file',
    'shareable-files' => 'Shareable files',
    'shareable-folder' => 'Unlock folder',
    'show-file' => 'Show file',
    ...
    'unlock-file-extension' => 'Unlock file extension',
    ...
    'file-access-m1' => 'File "<a href="%2$s" class="alert-link">%1$s</a>" is now locked',
    'file-access-m2' => 'File "<a href="%2$s" class="alert-link">%1$s</a>" is now shareable',
    'file-access-m3' => 'File "<a href="%2$s" class="alert-link">%1$s</a>" is now open to the public',
    'file-access-m4' => 'Not owner of file',
    'file-access-m5' => 'User was not found',
    ...
    'file-extension-hidden-m0' => 'File extension "%1$s" is now unlocked',
    'file-extension-hidden-m1' => 'File extension "%1$s" is now locked',
    ...
    'folder-access-m1' => 'Folder "<a href="%2$s" class="alert-link">%1$s</a>" is now locked',
    'folder-access-m2' => 'Folder "<a href="%2$s" class="alert-link">%1$s</a>" is now shareable',
    'folder-access-m3' => 'Folder "<a href="%2$s" class="alert-link">%1$s</a>" is now open to the public',
    'folder-access-m4' => 'Not owner of folder',
    'folder-access-m5' => 'User was not found',
    'folder-remove-m1' => 'Folder "%1$s" was removed',
    'folder-remove-m2' => 'Not owner of folder',
    ...
    'register-flash-m14' => 'Error Code: RF14',
    ...
    'user-update-m1' => 'Error code: UU1',
    'user-update-m2' => 'Password is changed',
    'user-update-m3' => '2FA is disabled',
    'user-update-m4' => 'Wrong Password',
    ...
    'user-two-factor-label' => 'Enable 2FA',
