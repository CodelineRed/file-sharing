...
This application based on [Slim Skeleton Fork 5](https://github.com/InsanityMeetsHH/Slim-Skeleton/tree/5.x) and [Gulp Templating 3.1](https://github.com/InsanityMeetsHH/gulp-templating/tree/3.x).
